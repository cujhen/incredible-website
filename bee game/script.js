...
//flower3.hit test
    let flower3Left = flower3.offsetLeft
    let flower3Top = flower3.offsetTop
    let dx4 = beeLeft - flower3Left
    let dy4 = beeTop - flower3Top
    //console.log("dx4=",dx4);
    dx4 = Math.abs(dx4)
    dy4 = Math.abs(dy4)
    if (dx4 <= 40 && dy4 <= 40) {
        console.log("hit flower3");
